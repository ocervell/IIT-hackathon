...
var marker = L.marker([init_lat, init_lng]).addTo(map)
      ...
      .openPopup();
var circle = L.circle([init_lat, init_lng], 200).addTo(map);
...
$("#slider").slider();
$( "#slider" ).slider("option", "min", 200); // minimum radius in meters
$( "#slider" ).slider("option", "max", 1000); // minimum radius in meters
...
//     var tlcIcon = new baseIcon({ iconUrl: 'static/images/taxi.png' });
//     var dotIcon = new baseIcon({ iconUrl: 'static/images/dot.png' });
//     var parksIcon = new baseIcon({ iconUrl: 'static/images/parks.png' });
//     var buildingsIcon = new baseIcon({ iconUrl: 'static/images/buildings.png' });
//     var nypdIcon = new baseIcon({ iconUrl: 'static/images/nypd.png' });
